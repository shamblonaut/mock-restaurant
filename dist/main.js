...
.phone {
    ...
    text-align: center;
    margin-top: 10px;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAEA;IACI,oBAAoB;IACpB,qBAAqB;IACrB,kBAAkB;AACtB;;AAEA;IACI,SAAS;IACT,UAAU;IACV,sBAAsB;AAC1B;;AAEA;IACI,iFAAyE;IACzE,sBAAsB;IACtB,+BAA+B;AACnC;;AAEA;IACI,uBAAuB;IACvB,cAAc;;IAEd,aAAa;IACb,sBAAsB;IACtB,mBAAmB;AACvB;;AAEA;IACI,iBAAiB;IACjB,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,OAAO;IACP,uBAAuB;IACvB,mBAAmB;IACnB,6BAA6B;IAC7B,YAAY;IACZ,cAAc;IACd,kBAAkB;AACtB;;AAEA;IACI,2BAA2B;AAC/B;;AAEA;IACI,mCAAmC;IACnC,eAAe;IACf,cAAc;AAClB;;AAEA;IACI,WAAW;IACX,YAAY;IACZ,mBAAmB;IACnB,mBAAmB;IACnB,kCAAkC;IAClC,wBAAwB;AAC5B;;AAEA;IACI,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,kBAAkB;IAClB,iBAAiB;IACjB,gBAAgB;IAChB,kBAAkB;IAClB,qBAAqB;AACzB;;AAEA;IACI,gBAAgB;IAChB,wBAAwB;IACxB,iBAAiB;AACrB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,mBAAmB;IACnB,gBAAgB;AACpB;;AAEA;IACI,iBAAiB;IACjB,kBAAkB;IAClB,qBAAqB;IACrB,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,WAAW;IACX,YAAY;IACZ,kBAAkB;AACtB;;AAEA;IACI,gBAAgB;;IAEhB,aAAa;IACb,sBAAsB;IACtB,mBAAmB;AACvB;;AAEA;IACI,cAAc;IACd,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,gBAAgB;AACpB;;;AAGA;IACI,WAAW;IACX,aAAa;;IAEb,aAAa;IACb,qCAAqC;IACrC,gBAAgB;IAChB,YAAY;IACZ,kBAAkB;IAClB,kBAAkB;AACtB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,gCAAgC;IAChC,mBAAmB;IACnB,aAAa;AACjB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,cAAc;IACd,iBAAiB;IACjB,gBAAgB;AACpB;;AAEA;IACI,cAAc;IACd,iBAAiB;IACjB,gBAAgB;AACpB;;;AAGA;IACI,aAAa;IACb,sBAAsB;IACtB,mBAAmB;AACvB;;AAEA;IACI,WAAW;IACX,aAAa;IACb,mCAAmC;IACnC,YAAY;IACZ,mBAAmB;IACnB,aAAa;AACjB;;AAEA;IACI,gBAAgB;IAChB,kBAAkB;IAClB,gCAAgC;IAChC,YAAY;IACZ,mBAAmB;IACnB,cAAc;AAClB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,mBAAmB;;IAEnB,gBAAgB;AACpB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,gBAAgB;AACpB;;AAEA;IACI,mCAAmC;IACnC,mBAAmB;IACnB,aAAa;IACb,YAAY;IACZ,cAAc;;IAEd,aAAa;IACb,sBAAsB;IACtB,8BAA8B;AAClC;;AAEA;IACI,aAAa;IACb,uCAAuC;IACvC,gBAAgB;AACpB;;AAEA;IACI,eAAe;IACf,gBAAgB;IAChB,oBAAoB;AACxB;;AAEA;IACI,eAAe;IACf,sBAAsB;IACtB,gBAAgB;AACpB;;AAEA;IACI,eAAe;;IAEf,YAAY;IACZ,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,kBAAkB;IAClB,gBAAgB;IAChB,kBAAkB;IAClB,gBAAgB;AACpB","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Grand+Hotel&display=swap');\n\n:root {\n    --dark-blue: #34435E;\n    --light-blue: #B8DBD9;\n    --saffron: #F9C846;\n}\n\n* {\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n}\n\nbody {\n    background: url(\"../assets/restaurant.jpg\") no-repeat rgba(0, 0, 0, 0.65);\n    background-size: cover;\n    background-blend-mode: multiply;\n}\n\n#content {\n    font-family: sans-serif;\n    color: #ffffff;\n\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n}\n\n.nav {\n    min-height: 100px;\n    display: flex;\n    align-self: stretch;\n}\n\n.tab {\n    display: flex;\n    flex: 1;\n    justify-content: center;\n    align-items: center;\n    background-color: transparent;\n    border: none;\n    color: #ffffff;\n    font-size: 1.25rem;\n}\n\n.tab.active {\n    background-color: #34435e40;\n}\n\n.heading {\n    font-family: 'Grand Hotel', cursive;\n    font-size: 3rem;\n    margin: 25px 0;\n}\n\n.main {\n    width: 60vw;\n    height: 70vh;\n    padding: 50px 125px;\n    border-radius: 25px;\n    background-color: var(--dark-blue);\n    color: var(--light-blue);\n}\n\n.quotes {\n    width: 65px;\n    height: auto;\n}\n\n.text {\n    padding-left: 30px;\n    font-size: 1.5rem;\n    font-weight: 300;\n    font-style: italic;\n    color: var(--saffron);\n}\n\n.author {\n    font-weight: 700;\n    color: var(--light-blue);\n    text-align: right;\n}\n\n.visit {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    margin-top: 50px;\n}\n\n.title {\n    font-size: 1.5rem;\n    font-style: italic;\n    color: var(--saffron);\n    margin-bottom: 25px;\n}\n\n.location {\n    display: flex;\n    align-items: center;\n}\n\n.pin {\n    width: 20px;\n    height: auto;\n    margin-right: 10px;\n}\n\n.hours {\n    margin-top: 50px;\n\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n}\n\n.hours>.title {\n    color: #ffffff;\n    font-style: normal;\n}\n\n.timing {\n    display: grid;\n    grid-auto-flow: column;\n    column-gap: 25px;\n}\n\n\n.main.menu {\n    width: 70vw;\n    padding: 75px;\n\n    display: grid;\n    grid-template-columns: repeat(3, 1fr);\n    column-gap: 25px;\n    row-gap: 8vh;\n    overflow-x: hidden;\n    overflow-y: scroll;\n}\n\n.item {\n    width: 350px;\n    height: 250px;\n    background-color: var(--saffron);\n    border-radius: 25px;\n    padding: 20px;\n}\n\n.picture.food {\n    width: 300px;\n    height: 150px;\n    border-radius: 25px;\n}\n\n.name.food {\n    color: #000000;\n    font-size: 1.5rem;\n    font-weight: 700;\n}\n\n.price {\n    color: #000000;\n    font-size: 1.5rem;\n    font-weight: 300;\n}\n\n\n.message {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n}\n\n#thoughts {\n    width: 30vw;\n    height: 150px;\n    background-color: var(--light-blue);\n    border: none;\n    border-radius: 10px;\n    padding: 10px;\n}\n\n.send {\n    margin-top: 10px;\n    padding: 10px 20px;\n    background-color: var(--saffron);\n    border: none;\n    border-radius: 10px;\n    color: #ffffff;\n}\n\n.call {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n\n    margin-top: 50px;\n}\n\n.contacts {\n    display: grid;\n    grid-auto-flow: column;\n    column-gap: 50px;\n}\n\n.card {\n    background-color: var(--light-blue);\n    border-radius: 10px;\n    padding: 25px;\n    width: 300px;\n    color: #000000;\n    \n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n}\n\n.info {\n    display: grid;\n    grid-template-columns: auto min-content;\n    column-gap: 25px;\n}\n\n.name.person {\n    grid-row: 1 / 2;\n    font-weight: 700;\n    align-self: flex-end;\n}\n\n.position {\n    grid-row: 2 / 3;\n    align-self: flex-start;\n    font-weight: 300;\n}\n\n.picture.person {\n    grid-row: 1 / 3;\n\n    width: 100px;\n    height: 100px;\n    border-radius: 50px;\n}\n\n.phone {\n    font-size: 1.25rem;\n    font-weight: 600;\n    text-align: center;\n    margin-top: 10px;\n}"],"sourceRoot":""}]);
// Exports
